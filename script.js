...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var faqs = [
    ...
    },
    {
      ...
      a: 'There are three primary quotients assessed at Bhava Tech. IQ (Intelligence Quotient) measures logical reasoning, memory, problem-solving, and processing speed. EQ (Emotional Quotient) measures self-awareness, empathy, emotional regulation, and social skills. SQ (Spiritual Quotient) measures inner clarity, sense of purpose, and values alignment. Together they give a complete picture of cognitive and personal development.'
    },
    {
    ...
    {
      q: 'What are the benefits of SQ (Spiritual Quotient) assessment?',
